if surface_exists(sombra_surface){
	...
	if instance_exists(obj_candelabro){
	var _num = instance_number(obj_candelabro);
	
	for (var i = 0; i < _num; i++){
	var _inst = instance_find(obj_candelabro, i);	
	...
	if instance_exists(obj_candelabro2){
	var _num = instance_number(obj_candelabro2);
	
	for (var i = 0; i < _num; i++){
	var _inst = instance_find(obj_candelabro2, i);	
