...
//desenha o texto de game over
	...
	draw_text_transformed(_camx + _camw/2,_camy +_camh/2 + _gameoverxoffset,"Complete level",6,6,0);
	

	//"shoot to restart cowgirl"
	var _restartxoffset = 80;
	draw_text_transformed(_camx + _camw/2,_camy + _camh/2 + _restartxoffset,"- Shoot to Next Challenge -",2,2,0);
